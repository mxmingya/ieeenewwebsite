...
* If you have trouble **maintaining the member's session** or [CSRF][] protection
...
* By default, `fetch` **won't send or receive any cookies** from the server,
  resulting in unauthenticated requests if the site relies on maintaining a member
