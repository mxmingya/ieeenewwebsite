...
.IP \(bu 2
per\-member configuration file (defaults to \fB$HOME/\.npmrc\fP; configurable via CLI
...
should be polled while the member is completing authentication\.
.SS sso\-type
.RS 0
.IP \(bu 2
Default: 'oauth'
...
.RE
.P
The location of member\-level configuration settings\.
.SS umask
.RS 0
.IP \(bu 2
Default: 022
