...
for packages to which you have at least read access\. If \fB<member>\fP is passed in,
the list is filtered only to teams \fIthat\fR member happens to belong to\.
.IP \(bu 2
edit:
