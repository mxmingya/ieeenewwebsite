...
.SH "NAME"
\fBnpm-adduser\fR \- Add a registry member account
.SH SYNOPSIS
.P
.RS 2
.nf
...
.SH DESCRIPTION
.P
Create or verify a member named \fB<username>\fP in the specified registry, and
...
.P
You may use this command multiple times with the same member account to
...
Default: none
.P
If specified, the member and login credentials given will be associated
...
.RE
.P
This will set a registry for the given scope and login or create a member for
