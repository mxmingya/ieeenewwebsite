...
That is, if your package is named \fBfoo\fP, and a member installs it, and then does
...
\fBnpm_package_config_port\fP environment variable, then the member could
...
"member/foo\-project"\.  Just as with git URLs, a \fBcommit\-ish\fP suffix can be
...
.RE
.P
Unless the member has set the \fBengine\-strict\fP config flag, this
...
member had set \fBengine\-strict\fP\|\. It is no longer used\.
.SH os
.P
