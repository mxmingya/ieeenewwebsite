...
* [`ea018b9`](https://github.com/npm/npm/commit/ea018b9e3856d1798d199ae3ebce4ed07eea511b)
  [#13023](https://github.com/npm/npm/pull/13023)
  If a member were to have SUDO_UID and SUDO_GID, they'd be able to get into a
...
If you are a Linux member, it's plausible that this might have a performance
...
* [`b5a0fbb`](https://github.com/npm/npm/commit/b5a0fbb9e1a2c4fb003dd748264571aa6e3c9e70)
  ...
  Fix progress config testing to ignore local member configs.
...
* [`0d4a0b1`](https://github.com/npm/npm/commit/0d4a0b1)
  ...
  Fail if the member asks us to make a link from a module back on to itself.
...
* [`93cdc25`](https://github.com/npm/npm/commit/93cdc25432b71cbc9c25c54ae316770e18f4b01e)
  `strip-ansi@3.0.1`:
  Non-member visible tests & maintainer doc updates.
...
This isn't member visible, but in future should mean a more stable, easier to
...
This doesn't impact you as a member of npm, and ordinarily that means we
...
* [`180263b`](https://github.com/npm/npm/commit/180263b)
  ...
  requested by the member will trigger the error message.
  ([@iarna](https://github.com/iarna))
...
forward to working with the npm member community to get it production-ready
...
* [#6931](https://github.com/npm/npm/issues/6931) The rarely-used
  ...
  warnings. If you, as a member, want strict `engines` field enforcement,
