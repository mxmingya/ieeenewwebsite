...
As a member, all you have to do is update to get to use the new API.  If
...
* [`def75eebf`](https://github.com/npm/npm/commit/def75eebf1ad437bf4fd3f5e103cc2d963bd2a73)
  ...
  Preserve case of the member name part of shortcut specifiers, previously they were lowercased.
  ([@iarna](https://github.com/iarna))
...
* [`af06aa9`](https://github.com/npm/npm/commit/af06aa9a357578a8fd58c575f3dbe55bc65fc376)
  ...
  packages with that scope. That is, member `@alice` is not allowed to publish to
  `@bob/my-package` unless explicitly made an owner by member (or org) `@bob`.
...
* [`d76e084`](https://github.com/npm/npm/commit/d76e08463fd65705217624b861a1443811692f34)
  Disable metric reporting for test suite even if the member has it enabled.
  ([@iarna](https://github.com/iarna))
...
* [`54d949b`](https://github.com/npm/npm/commit/54d949b05adefffeb7b5b10229c5fe0ccb929ac3)
  ...
  `lockfile@1.0.3`:
  Handled case where callback was not passed in by the member.
...
before we push it out to the member community at large, so I decided to do this
...
* [`6b6bb08`](https://github.com/npm/npm/commit/6b6bb08af661221224a81df8adb0b72019ca3e11)
  ...
  implement member/scope-aware features and services.
  ([@iarna](https://github.com/iarna))
