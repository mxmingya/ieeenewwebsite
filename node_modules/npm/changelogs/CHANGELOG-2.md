...
* [`5cd3abc`](https://github.com/npm/npm/commit/5cd3abc3511515e09b4a1b781c0520e84c267c5b)
  ...
  Document that the member config file can itself be configured either through the
...
* [`d681e16`](https://github.com/npm/npm/commit/d681e16a475a49d6196af9a5cedaaf88712f3a9f)
  [npm/npm-member-validate#9](https://github.com/npm/npm-member-validate/pull/9)
  `npm-member-validate@0.1.5`:
...
* [`d682e64`](https://github.com/npm/npm/commit/d682e6445845b0a2584935d5e2942409c43f6916)
  [npm/npm-member-validate#8](https://github.com/npm/npm-member-validate/pull/8)
  `npm-member-validate@0.1.4`: Add a maximum length limit for usernames based on
...
* [`8324ea0`](https://github.com/npm/npm/commit/8324ea023ace4e08b6b8959ad199e2457af9f9cf)
  [#9761](https://github.com/npm/npm/pull/9761) Added general member guide for
  Orgs.
...
that look like `git+https://member@host:path/is/here`.

Rebecca: What should we use instead?!

Kat: Just do me a solid and use `git+ssh://member@host:path/here` or
`git+https://member@host/absolute/https/path` instead!
...
URLs of the format `git+ssh://member@githost.com:org/repo.git` suddenly stopped
...
* [`94ca4a7`](https://github.com/npm/npm/commit/94ca4a711619ba8e40ce3d20bc42b13cdb7611b7)
  ...
  `git+ssh://member@githost.com:org/repo.git` isn't a URL, treat it like one for
...
the wrong member (almost always root), and that can, well, it can cause problems
...
* Switch license to
  ...
  plain "BSD" ([@isaacs](https://github.com/isaacs)):
    * [`efdb733`](https://github.com/npm/npm/commit/efdb73332eeedcad4c609796929070b62abb37ab) `npm-member-validate@0.1.2`
...
For you as a member of npm, this means:
...
* [`6b0f588`](https://github.com/npm/npm/commit/6b0f58877f37df9904490ffbaaad33862bd36dce)
  ...
  URLs as presented by member. Support new `hosted-git-info` shortcut syntax.
...
* [`89fc6a4`](https://github.com/npm/npm/commit/89fc6a4e7ff8c524675fcc14493ca0a1e3a76d38)
  `which@1.0.9`: Test for being run as root, as well as the current member.
  ([@isaacs](https://github.com/isaacs))
...
* [`f1c8bdb`](https://github.com/npm/npm/commit/f1c8bdb3f6b753d0600597e12346bdc3a34cb9c1)
  ...
  strings that should be returned to the member.
...
* [`740f483`](https://github.com/npm/npm/commit/740f483db6ec872b453065842da080a646c3600a)
  legacy tests no longer poison member's own cache
  ([@othiym23](https://github.com/othiym23))
...
* [`01ec790`](https://github.com/npm/npm/commit/01ec790fd47def56eda6abb3b8d809093e8f493f)
  `npm-member-validate@0.1.1`: Correct repository URL.
  ([@robertkowalski](https://github.com/robertkowalski))
...
* [`ed207e8`](https://github.com/npm/npm/commit/ed207e88019de3150037048df6267024566e1093)
  ...
  auth decisions. Also error on trying to change a member document without
