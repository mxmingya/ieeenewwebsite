...
<p>npm also sets a top-level &quot;maintainers&quot; field with your npm member info.</p>
...
That is, if your package is named <code>foo</code>, and a member installs it, and then does
...
&quot;repository&quot;: &quot;github:member/repo&quot;

&quot;repository&quot;: &quot;gist:11081aaa281&quot;

&quot;repository&quot;: &quot;bitbucket:member/repo&quot;

&quot;repository&quot;: &quot;gitlab:member/repo&quot;
...
<code>npm_package_config_port</code> environment variable, then the member could
...
<li><code>member/repo</code> See &#39;GitHub URLs&#39; below</li>
...
<pre><code>&lt;protocol&gt;://[&lt;member&gt;[:&lt;password&gt;]@]&lt;hostname&gt;[:&lt;port&gt;][:][/]&lt;path&gt;[#&lt;commit-ish&gt; | #semver:&lt;semver&gt;]
...
&quot;member/foo-project&quot;.  Just as with git URLs, a <code>commit-ish</code> suffix can be
...
<pre><code>{
  ...
  &quot;dependencies&quot;: {
    ...
    &quot;module&quot;: &quot;member/repo#feature\/branch&quot;
  }
}
...
</code></pre><p>Unless the member has set the <code>engine-strict</code> config flag, this
...
member had set <code>engine-strict</code>. It is no longer used.</p>
<h2 id="os">os</h2>
