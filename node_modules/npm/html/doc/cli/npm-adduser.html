...
<h1><a href="../cli/npm-adduser.html">npm-adduser</a></h1> <p>Add a registry member account</p>
<h2 id="synopsis">SYNOPSIS</h2>
<pre><code>npm adduser [--registry=url] [--scope=@orgname] [--always-auth] [--auth-type=legacy]

aliases: login, add-member
</code></pre><h2 id="description">DESCRIPTION</h2>
<p>Create or verify a member named <code>&lt;username&gt;</code> in the specified registry, and
...
<p>You may use this command multiple times with the same member account to
...
<p>Default: none</p>
<p>If specified, the member and login credentials given will be associated
...
</code></pre><p>This will set a registry for the given scope and login or create a member for
