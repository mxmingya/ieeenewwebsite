...
exist and can be written by the current member.</li>
...
<ul>
<li>Your cache must be readable and writable by the member running npm.</li>
<li>Global package binaries must be writable by the member running npm.</li>
<li>Your local <code>node_modules</code> path, if you&#39;re running <code>npm doctor</code> with a project
directory, must be readable and writable by the member running npm.</li>
</ul>
