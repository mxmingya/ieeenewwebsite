...
<pre><code>git://github.com/member/project.git#commit-ish
git+ssh://member@hostname:project.git#commit-ish
git+http://member@hostname/project/blah.git#commit-ish
git+https://member@hostname/project/blah.git#commit-ish
...
<h2 id="create-a-member-account">Create a User Account</h2>
<p>Create a member with the adduser command.  It works like this:</p>
