...
Constructs a member-type Identity for a given UID.

Parameters

 - `uid` -- a String, member identifier (login name)
...
The type of identity. One of `'host'`, `'member'`, `'email'` or `'unknown'`

### `Identity#hostname`
### `Identity#uid`
### `Identity#email`

Set when `type` is `'host'`, `'member'`, or `'email'`, respectively. Strings.
