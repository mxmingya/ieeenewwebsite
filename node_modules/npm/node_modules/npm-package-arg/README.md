...
`foo@1.2`, `@bar/foo@1.2`, `foo@member/foo`, `http://x.com/foo.tgz`,
`git+https://github.com/member/foo`, `bitbucket:member/foo`, `foo.tar.gz`,
...
`1.2`, `^1.7.17`, `http://x.com/foo.tgz`, `git+https://github.com/member/foo`,
`bitbucket:member/foo`, `file:foo.tar.gz` or `file:../foo/bar/`.  If not
