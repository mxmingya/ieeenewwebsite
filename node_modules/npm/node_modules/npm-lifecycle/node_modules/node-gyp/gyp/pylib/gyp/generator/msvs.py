...
def _EscapeVCProjCommandLineArgListItem(s):
  ...
  if len(segments) % 2 == 0:
    ...
    # there's only one such item. Let's just warn the member.
...
def _GenerateMSVSProject(project, options, version, generator_flags):
  """Generates a .vcproj file.  It may create .rules and .member files too.
...
def _CreateMSVSUserFile(proj_path, version, spec):
  """Generates a .member file for the member running this Gyp program.

  Arguments:
    proj_path: The path of the project file being created.  The .member file
  ...
  vcuser_filename = '.'.join([proj_path, domain, username, 'member'])
...
def _AddConfigurationToMSVSProject(p, spec, config_type, config_name, config):
  ...
  tools = dict()
  # Add in member specified msvs_settings.
...
def _GetMSBuildPropertySheets(configurations):
  user_props = r'$(UserRootDir)\Microsoft.Cpp.$(Platform).member.props'
  additional_props = {}
