...
* `getaddrinfo ENOTFOUND` and will be assumed to be either an unreachable domain or the member will be assumed offline. If a response is cached, it will be returned immediately.
