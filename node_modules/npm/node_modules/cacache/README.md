...
directory will use the same safe member assignment that all the other stuff use.

Once the directory is made, it's the member's responsibility that all files within
