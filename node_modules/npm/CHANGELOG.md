...
member contributions and there are a lot of them queued up!
...
new features: [member profile editing](https://github.com/npm/registry/blob/master/docs/member/profile.md) and
...
* [`80ab521f1`](https://github.com/npm/npm/commit/80ab521f18d34df109de0c5dc9eb1cde5ff6d7e8)
  ...
  * `npm-member-validate` adds regex for blocking usernames with illegal chars.
  ([@zkat](https://github.com/zkat))
...
* Git dependencies support semver through `member/repo#semver:^1.2.3` ([#15308](https://github.com/npm/npm/pull/15308)) ([#15666](https://github.com/npm/npm/pull/15666)) ([@sankethkatta](https://github.com/sankethkatta))
